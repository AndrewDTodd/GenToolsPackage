#ifndef GENTOOLS_GENSERIALIZE_GENDERATED_FILE_MANAGER_H
#define GENTOOLS_GENSERIALIZE_GENDERATED_FILE_MANAGER_H
...
#endif // !GENTOOLS_GENSERIALIZE_GENDERATED_FILE_MANAGER_H
